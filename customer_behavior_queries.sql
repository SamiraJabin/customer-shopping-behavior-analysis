...
Select subscription_status, COUNT(customer_id) as total_customers, AVG(purchase_amount) as avg_spend, SUM(purchase_amount) as revenue
from customer
...
-- we will need a window function to rank products
with item_counts as (
